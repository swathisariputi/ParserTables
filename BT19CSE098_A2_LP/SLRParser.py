...
class SLRParser:
    ...
    def generate_automaton(self):
        ...
        z=str(automaton)            
        s = Source(str(automaton), filename="test2.gv", format="png")
        s1=Source(z,filename="temp.gv",format="png")
        s1.view()
        #s.view()
        import matplotlib.pyplot as plt
        import matplotlib.image as mpimg
        img = mpimg.imread('test.gv.png')
...
parser.add_argument('-input', action='store_true', help='input to parse') 
...
if args.input:
    ...
    print("Input string ",tokens,"parse table")
